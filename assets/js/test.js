...
branchAddBtn.addEventListener('click', async function () {
    const branchData = {
        ...
        Status: document.getElementById('branchStatus').value.trim(),
        CompanyID: companyID,
    ...
    if (event.target.classList.contains('selectBranch')) {
        ...
        if (event.target.checked) {
            ...
            try {
                ...
                // Change button text
                branchAddBtn.innerText = 'Edit Branch Details';
...
function resetBranchForm() {
    ...
    // Reset UI elements
    rowIDEdit = null;
    document.getElementById('branchAddDetails').innerText = 'Add Branch Details';
}

// Add/Edit Branch Bank Details
branchBankAddBtn.addEventListener('click', async function () {
    const bankData = {
        ...
        DefaultBank: document.getElementById('branchDefaultBank').value.trim(),
        BankStatus: document.getElementById('branchAccountStatus').value.trim(),
        CompanyID: companyID,
